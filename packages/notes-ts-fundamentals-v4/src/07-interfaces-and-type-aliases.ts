...
type SpecialDate = Date & { getDescription(): string } //*  <------------------ IMPORTANT
//?                     ^ why is this `&` and not `|` ?
...
class Dog2
    ...
    implements AnimalLike, CanBark { //? classes can implement multiple interfaces
    bark() {
        return "woof"
    }
    eat(food: string) {
...
//✔️ Interfaces can be augmented, type aliases cannot
